...
proto.getBucketLocation = async function getBucketLocation(name, region, options) {
...
proto.getBucketInfo = async function getBucketInfo(name, region, options) {
  name = name || this.getBucket();
...
proto.putBucket = async function putBucket(name, region, options) {
  options = options || {};
...
proto.deleteBucket = async function deleteBucket(name, region, options) {
...
proto.putBucketACL = async function putBucketACL(name, region, acl, options) {
...
proto.getBucketACL = async function getBucketACL(name, region, options) {
...
proto.putBucketLogging = async function putBucketLogging(name, region, prefix, options) {
...
proto.getBucketLogging = async function getBucketLogging(name, region, options) {
...
proto.deleteBucketLogging = async function deleteBucketLogging(name, region, options) {
...
proto.putBucketWebsite = async function putBucketWebsite(name, region, config, options) {
  // config: index, [error]
...
proto.getBucketWebsite = async function getBucketWebsite(name, region, options) {
...
proto.deleteBucketWebsite = async function deleteBucketWebsite(name, region, options) {
...
proto.putBucketLifecycle = async function putBucketLifecycle(name, region, rules, options) {
  // rules: [rule, ...]
...
proto.getBucketLifecycle = async function getBucketLifecycle(name, region, options) {
...
proto.deleteBucketLifecycle = async function deleteBucketLifecycle(name, region, options) {
...
proto.putBucketCORS = async function putBucketCORS(name, region, rules, options) {
  rules = rules || [];
...
proto.getBucketCORS = async function getBucketCORS(name, region, options) {
...
proto.deleteBucketCORS = async function deleteBucketCORS(name, region, options) {
...
proto.putBucketReferer = async function putBucketReferer(name, region, allowEmpty, referers, options) {
...
proto.getBucketReferer = async function getBucketReferer(name, region, options) {
...
proto.deleteBucketReferer = async function deleteBucketReferer(name, region, options) {
  const result = await this.putBucketReferer(name, region, true, null, options);
  return result;
};
